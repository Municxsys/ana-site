  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <Card title="Medizinische Fußpflege" price="45 €" img="/images/service1.jpg">
      ...
      <div className="mt-10 grid md:grid-cols-2 gap-8">
        ...
        <Card title="Shellac-Behandlung" price="nach Aufwand" img="/images/service4.jpg">
        ...
        <Card title="B/S-Spange Classic" price="30 €" img="/images/service5.jpg">
          <p className="text-green-harmony">
            Sanfte Korrektur bei eingewachsenen Nägeln – wasserfest und unauffällig.
          </p>
